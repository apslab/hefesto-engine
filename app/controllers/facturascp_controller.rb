class FacturascpController < AuthorizedController
  # GET /facturas
  # GET /facturas.xml
  ...
  def new
    ...
    @factura.supplier_id = @supplier.id
  ...
  def imprimir
     ...
     Prawn::Document.generate('factura.pdf') do |pdf|
       ...
       pdf.draw_text @factura.supplier.condicioniva.letra.to_s, :at => [243,710], :size => 16
...
# recuadro de la letra
       ...
       pdf.draw_text "Razon social : " + @factura.supplier.razonsocial, :at => [10,640], :size => 10
       pdf.draw_text "CUIT : " + @factura.supplier.cuit, :at => [10,630], :size => 10
       pdf.draw_text "Condicion de IVA:" + @factura.supplier.condicioniva.detalle, :at => [10,620], :size => 10
       pdf.draw_text "Direccion : " + @factura.supplier.direccion, :at => [10,610], :size => 10
